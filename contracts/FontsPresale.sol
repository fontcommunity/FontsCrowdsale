...
contract FontsPresale is Context, ReentrancyGuard, Ownable {
    ...
    //Change this to true if you run for testnets 
    bool constant IS_TESTNET_LOCAL = true;
    ...
    //=======================================================================//
    //          Contract Variables: Testnet variable for quick test          //
    //=======================================================================//
    //All Variables with _TN_ prefix is for Testnets, This values are passed in constructor via ChangeSettingsForTestnet()
    uint256 public constant _TN_MIN_CONTRIBUTION = 0.1 ether;
    uint256 public constant _TN_MAX_CONTRIBUTION = 15 ether;

    uint256 public constant _TN_HARD_CAP = 4.5 ether; //@change for testing
    uint256 public constant _TN_UNI_LP_ETH = 2.15 ether;

    uint256 public constant _TN_DURATION_REFUND = 7 minutes;
    uint256 public constant _TN_DURATION_LIQUIDITY_LOCK = 45 minutes;

    uint256 public constant _TN_DURATION_TOKEN_DISTRIBUTION_ROUND_2 = 8 minutes;
    uint256 public constant _TN_DURATION_TOKEN_DISTRIBUTION_ROUND_3 = 15 minutes;    

    address _TN_FONT_TOKEN_ADDRESS = 0x733dBD408ee27EFEA65ca8d1219AB042868CEd78; 
    ...
    //This function change some basic variable like durations / ETH for testnets for quick testing
    //@done
    function ChangeSettingsForTestnet() internal {
        if(IS_TESTNET_LOCAL) {
            MIN_CONTRIBUTION = _TN_MIN_CONTRIBUTION;
            MAX_CONTRIBUTION = _TN_MAX_CONTRIBUTION;

            HARD_CAP = _TN_HARD_CAP; //@change for testing
            UNI_LP_ETH = _TN_UNI_LP_ETH;//


            DURATION_REFUND = _TN_DURATION_REFUND;
            DURATION_LIQUIDITY_LOCK = _TN_DURATION_LIQUIDITY_LOCK;

            DURATION_TOKEN_DISTRIBUTION_ROUND_2 = _TN_DURATION_TOKEN_DISTRIBUTION_ROUND_2;
            DURATION_TOKEN_DISTRIBUTION_ROUND_3 = _TN_DURATION_TOKEN_DISTRIBUTION_ROUND_3;    

            //Address for ERC20 Token
            FONT_ERC20 = IERC20(_TN_FONT_TOKEN_ADDRESS); 
        }
        else {
